...
public class ArrayBasedBag implements BagADT
{
     ...
     * 
     * @param initialCapacity desired initial capacity of array
     */
    ...
    {
        //Loop up until i == size instead of contents.length to avoid null elements
    ...
    // ----------------------------------------------------------
    /**
     * Finds the number of a specified item in the bag.
     * 
